...
public class GoalManager
{
    ...
    public void DisplayPlayerInfo()
    {
        ...
        if (_score >= 5000) rank = "Eternal Master";
        else if (_score >= 3000) rank = "High Achiever";
        else if (_score >= 1000) rank = "Goal Crusher";
    ...
    public void LoadGoals()
    {
        ...
        for (int i = 1; i < lines.Length; i++)
        {
            ...
            else if (type == "ChecklistGoal")
            {
                ...
                var goal = new ChecklistGoal(details[0], details[1], int.Parse(details[2]), int.Parse(details[4]), int.Parse(details[3]));
